...
class Utilisateur:
    ...
    class Update:
        ...
        def update_theme_utilisateur(cnx, id, theme):
            try :
                print("update UTILISATEUR set themeLight = '" + theme + "' where idUtilisateur = '" + str(id) + "';")
                cnx.execute(text("update UTILISATEUR set themeLight = '" + theme + "' where idUtilisateur = '" + str(id) + "';"))
                cnx.commit()
            except:
