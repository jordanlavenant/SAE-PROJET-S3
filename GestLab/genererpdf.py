...
class PDF_BonCommande:
    class PDF(FPDF):
        ...
        def affiche_FDS(self,referenceMateriel, nomMateriel, estToxique, estInflamable, estExplosif,est_gaz_sous_pression, est_CMR, est_chimique_environement, est_dangereux, est_comburant,est_corrosif ):
            ...
            lienImageToxique = lien + "toxique.png"
            lienImageInflamable = lien + "inflammable.png"
            lienImageCorrosif = lien + "corrosif.png"
            lienImageExplosif = lien + "explosion.png"
            lienImageGazSousPression = lien + "gaz.png"
            lienImageCMR = lien + "CMR.png"
